...
class MotionPlanner(Node):
    def __init__(self):
        ...
        # Advanced 360-degree Helical Scan Pattern
        # Format: [shoulder_pan, shoulder_lift, elbow, wrist_1, wrist_2, wrist_3]
        self.scanning_poses = [
            # High Level - 360 Degree Circle
            [0.0, -1.2, 1.2, -1.57, -1.57, 0.0],
            [1.57, -1.2, 1.2, -1.57, -1.57, 0.0],
            [3.14, -1.2, 1.2, -1.57, -1.57, 0.0],
            [-1.57, -1.2, 1.2, -1.57, -1.57, 0.0],
            
            # Mid Level - Tilted for Side Detail
            [0.78, -1.0, 1.0, -1.57, -1.57, 0.0],
            [2.35, -1.0, 1.0, -1.57, -1.57, 0.0],
            [-2.35, -1.0, 1.0, -1.57, -1.57, 0.0],
            [-0.78, -1.0, 1.0, -1.57, -1.57, 0.0],
            
            # Top-Down View for gaps
            [0.0, -0.6, 0.6, -1.57, -1.57, 0.0]
        ]
